-- Phase 1: Database Schema Enhancement for LiveKit Integration (without concurrent indexes)
...
-- 6. Add performance indexes (non-concurrent)
...
CREATE INDEX idx_streams_event_active ON event_streams(event_id, is_active);
