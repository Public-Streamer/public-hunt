...
const BankingInfoForm: React.FC<BankingInfoFormProps> = ({ onBankingInfoSaved }) => {
    ...
    <Card>
      ...
      <CardContent>
        <Alert className="mb-4">
          ...
          <AlertDescription>
            Your banking information is encrypted and securely stored. This is required for fund transfers.
          </AlertDescription>
        </Alert>
