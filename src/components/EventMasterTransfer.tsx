...
const EventMasterTransfer: React.FC<EventMasterTransferProps> = ({
  eventId,
  currentMaster,
  eventAdmins,
}) => {
  ...
  const filteredAdmins = eventAdmins.filter(
    (admin) =>
      ...
      <CardContent className="space-y-4">
        <div className="bg-yellow-50 p-4 rounded-lg">
          <div className="flex items-center">
            ...
            <p className="text-sm text-yellow-800">
              <strong>Important:</strong> Transferring Event Master role
              requires approval from the Channel Master.
            </p>
          </div>
        </div>
        ...
        {filteredAdmins.length === 0 && (
          <p className="text-gray-500 text-center py-4">
            No event administrators found. Only event administrators can become
            event masters.
          </p>
        )}
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to transfer Event Master role to{' '}
                {selectedAdmin?.name}? This action requires approval from the
                Channel Master and cannot be undone without their permission.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
