      ...
      <header className="bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              <Link to="/" className="flex items-center space-x-1 sm:space-x-3">
                <div className={`relative bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-sm rounded-xl border border-white/40 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 group ${
                  ...
                  <Zap className={`absolute -bottom-1 -left-1 text-yellow-300 animate-pulse ${isMobile ? 'h-3 w-3' : 'h-4 w-4'}`} style={{ filter: 'drop-shadow(2px 2px 4px rgba(0,0,0,0.7))' }} />
                  
                  {/* Dollar Sign - Bottom Right */}
                  <DollarSign className={`absolute -bottom-1 -right-1 text-green-300 animate-pulse ${isMobile ? 'h-3 w-3' : 'h-4 w-4'}`} style={{ animationDelay: '0.5s', filter: 'drop-shadow(2px 2px 4px rgba(0,0,0,0.7))' }} />
            ...
            <div className={`flex items-center ${isMobile ? 'space-x-1 ml-2' : 'space-x-3 ml-8'}`}>
