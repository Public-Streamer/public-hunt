              ...
              <Link to="/" className="flex items-center space-x-1">
                <div className="relative bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-sm rounded-xl border border-white/40 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105 group w-12 h-12 p-2" style={{ filter: 'drop-shadow(4px 4px 8px rgba(0,0,0,0.6))' }}>
                  ...
                  <div className="relative z-10 flex items-center justify-center h-full w-full">
                    ...
                    <Zap className="text-yellow-300 animate-pulse h-4 w-4 mr-0.5" style={{ filter: 'drop-shadow(2px 2px 4px rgba(0,0,0,0.7))', animationDuration: '0.8s' }} />
                    ...
                    <DollarSign className="text-green-300 animate-pulse h-4 w-4 ml-0.5" style={{ filter: 'drop-shadow(2px 2px 4px rgba(0,0,0,0.7))', animationDuration: '1.2s' }} />
                  </div>
