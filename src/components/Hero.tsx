        ...
        <div className="text-center mb-16">
          ...
          <div className="relative mb-6">
            ...
            >
              ...
              <span className="text-4xl sm:text-5xl md:text-6xl text-green-300">
                💲
              </span>
            </div>
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            ...
            Turn cell phones into professional streaming cameras—instantly
            become a production company of one.
          </p>
          <Button
        ...
        <div className="grid md:grid-cols-3 gap-2">
          <Card className="text-center p-2 hover:shadow-lg transition-shadow border-border">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-muted-foreground">
                Multiple phone streams in one event
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center p-2 hover:shadow-lg transition-shadow border-border">
            <CardContent className="pt-6">
              ...
              <p className="text-sm text-muted-foreground">
                Secure pay-per-view monetization
              </p>
            </CardContent>
          </Card>
