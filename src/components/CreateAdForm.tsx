        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload a video, image, or banner for your advertising campaign.
                Supported formats: MP4, JPG, PNG, GIF.
              </CardDescription>
            </CardHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Support for MP4, JPG, PNG, GIF files up to 50MB
                      </p>
                    </div>
              ...
              {campaignData.mediaPreview && (
                <div className="border rounded-lg p-4 bg-green-50">
                  ...
                  <p className="text-sm text-green-600">
                    Your ad content is ready. You can preview it above and
                    proceed to set your budget.
                  </p>
                </div>
              )}
            </CardContent>
        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                How much would you like to spend on this campaign? We'll
                optimize your ad delivery to maximize results.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      value={
                        campaignData.budget
                          ? parseFloat(campaignData.budget).toFixed(2)
                          : ''
                      }
                      onChange={(e) => {
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="bg-white rounded-lg p-3 border">
                      <div className="text-2xl font-bold text-green-600">
                        {estimate.impressions.toLocaleString()}
                      </div>
                      <div className="text-gray-600">Total Impressions</div>
                    </div>
                  </div>
                  <p className="text-xs text-blue-700 mt-3">
                    * Based on $10 CPM industry standard. Actual results may
                    vary based on targeting and content quality.
                  </p>
                </div>
              )}
            </CardContent>
            ...
            <CardContent className="space-y-6">
                ...
                >
                  <div className="flex items-center space-x-2 p-3 border rounded-lg">
                    ...
                    <Label htmlFor="views" className="flex-1">
                      ...
                      <div className="text-sm text-gray-500">
                        Get your ad seen by as many people as possible
                      </div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 p-3 border rounded-lg">
                  ...
                  <div className="flex items-center space-x-2 p-3 border rounded-lg">
                    ...
                    <Label htmlFor="awareness" className="flex-1">
                      ...
                      <div className="text-sm text-gray-500">
                        Increase recognition and recall of your brand
                      </div>
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setCampaignData({ ...campaignData, duration: value })
                  }
                >
                  <SelectTrigger>
                ...
                <p className="text-xs text-gray-500">
                  Longer durations typically cost more but provide better
                  engagement
                </p>
              </div>
            </CardContent>
        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Choose who sees your ads for better results (optional but
                recommended).
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setCampaignData({ ...campaignData, targeting: value })
                  }
                >
                  <div className="flex items-center space-x-2 p-3 border rounded-lg">
                    ...
                    <Label htmlFor="auto" className="flex-1">
                      ...
                      <div className="text-sm text-gray-500">
                        Let our system find the best audience for your ad
                      </div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 p-3 border rounded-lg">
                    ...
                    <Label htmlFor="custom" className="flex-1">
                      ...
                      <div className="text-sm text-gray-500">
                        Choose specific content types and audience preferences
                      </div>
                    </Label>
                  </div>
                </RadioGroup>
              ...
              {campaignData.targeting === 'custom' && (
                <>
                          ...
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => {
                              if (checked) {
                                ...
                                setCampaignData({
                                  ...campaignData,
                                  channels: campaignData.channels.filter(
                                    (c: string) => c !== type
                                  ),
                                });
                              }
                  ...
                  <div className="space-y-3">
                    <Label>
                      Age Range: {campaignData.ageRange[0]} -{' '}
                      {campaignData.ageRange[1]} years
                    </Label>
                    <Slider
                          ...
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => {
                              if (checked) {
                                ...
                                setCampaignData({
                                  ...campaignData,
                                  interests: campaignData.interests.filter(
                                    (i: string) => i !== interest
                                  ),
                                });
                              }
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      ...
                      <Label className="text-base font-medium">
                        Specific Channel & Event Targeting
                      </Label>
                    </div>
                    <p className="text-sm text-gray-600">
                      Target specific channels or events for higher engagement
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setCampaignData({ ...campaignData, schedule: value })
                  }
                >
                  <div className="flex items-center space-x-2 p-3 border rounded-lg">
                    ...
                    <Label htmlFor="immediate" className="flex-1">
                      ...
                      <div className="text-sm text-gray-500">
                        Begin showing ads as soon as payment is processed
                      </div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 p-3 border rounded-lg">
        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Review your campaign details and complete payment to launch your
                ads.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <p className="text-xs text-gray-500 text-center">
                By launching this campaign, you agree to our advertising terms
                and conditions. Your ads will be reviewed for compliance before
                going live.
              </p>
            </CardContent>
          </Card>
  ...
  const canProceed = () => {
    switch (step) {
      ...
      case 5:
        return (
          campaignData.schedule === 'immediate' ||
          (campaignData.schedule === 'scheduled' && campaignData.startDate)
        );
      default:
        return true;
    }
