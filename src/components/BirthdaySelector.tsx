    ...
    <div className={className}>
      ...
      <div className="grid grid-cols-3 gap-2">
        <div>
          ...
          >
            <SelectTrigger className="h-12 text-xs font-semibold bg-background border-2 shadow-sm text-center">
          ...
          <div className="mt-2 p-3 border-2 rounded-md text-center min-h-[40px] flex items-center justify-center">
            <span
              className={`text-lg font-bold drop-shadow-sm ${selectedMonth ? 'text-green-600 bg-green-50 border-green-200' : 'text-red-600 bg-red-50 border-red-200'}`}
            >
              {selectedMonth
        ...
        <div>
          ...
          <div className="mt-2 p-3 border-2 rounded-md text-center min-h-[40px] flex items-center justify-center">
            <span
              className={`text-lg font-bold drop-shadow-sm ${selectedDay ? 'text-green-600 bg-green-50 border-green-200' : 'text-red-600 bg-red-50 border-red-200'}`}
            >
        ...
        <div>
          ...
          <div className="mt-2 p-3 border-2 rounded-md text-center min-h-[40px] flex items-center justify-center">
            <span
              className={`text-lg font-bold drop-shadow-sm ${selectedYear ? 'text-green-600 bg-green-50 border-green-200' : 'text-red-600 bg-red-50 border-red-200'}`}
            >
