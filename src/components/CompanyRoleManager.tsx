...
const CompanyRoleManager: React.FC<CompanyRoleManagerProps> = ({
  companyId,
  isCompanyMaster,
}) => {
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-2">
                      ...
                      <Button
                        ...
                        className="whitespace-normal break-words leading-tight min-h-[40px] px-3 py-2"
                      >
                        <span className="text-xs sm:text-sm text-center">
                          Add Member
                        </span>
              ...
              >
                <div className="flex items-center space-x-3">
                  <Avatar>
                    ...
                    />
                    <AvatarFallback>
                      {member.user_profile?.display_name?.[0] ||
                        member.user_profile?.username[0]}
                    </AvatarFallback>
                  </Avatar>
                  <div>
                    <p className="font-medium">
