...
import { X, Star, ThumbsUp, Target, HelpCircle, Clock, Music, Laugh, Smartphone } from "lucide-react";
      ...
      <Card className="w-full max-w-md animate-scale-in">
        <CardHeader className="text-center space-y-2">
          <div className="flex justify-between items-center">
            <CardTitle className="text-lg">What did you think of this ad?</CardTitle>
            <Button
              variant="ghost"
              size="sm"
              onClick={onClose}
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium">Anything you'd like to tell the advertiser? (optional)</p>
            <Textarea
              value={feedbackText}
