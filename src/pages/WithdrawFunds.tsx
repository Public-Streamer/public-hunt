...
const generateSalesData = () => {
  ...
  sales.forEach(sale => {
    ...
    sale.stripeFee = sale.grossRevenue * 0.029 + 0.30; // Stripe fee
...
const WithdrawFunds: React.FC = () => {
  ...
  const totalRevenue = salesData.reduce((sum, sale) => sum + sale.netRevenue, 0);
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">Manage your earnings and transfer funds to your bank account</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Processing (7-14 days)</p>
              </CardContent>
            </Card>
                ...
                <CardContent>
                  <form onSubmit={handleWithdraw} className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <Button type="submit" disabled={!withdrawAmount || !bankInfo.accountNumber}>
                        Request Withdrawal
                      </Button>
