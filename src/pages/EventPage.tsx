...
const EventPage: React.FC = () => {
  ...
  const mediaData = eventData.media_urls?.map((url, index) => ({
    id: index.toString(),
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-lg text-gray-700 mb-6">{eventData.description}</p>
          ...
          {!eventData.is_live && (
            <OfflineStreamSection eventId={eventData.id} hasPaid={hasTicket || isEventHost} />
          )}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">{eventData.category || 'General'}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-600">{(eventData.viewer_count || 0).toLocaleString()}</p>
              </div>
              {hasTicket && (
                <div>
