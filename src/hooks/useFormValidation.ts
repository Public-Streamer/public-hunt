...
export const validationRules = {
  ...
  phone: (message = 'Please enter a valid phone number (XXX-XXX-XXXX)'): ValidationRule => ({
    test: (value) => {
  ...
  passwordMatch: (confirmPassword: string, message = 'Passwords do not match'): ValidationRule => ({
    test: (password) => !password || !confirmPassword || password === confirmPassword,
    message
  }),

  age: (minAge: number, birthDate: string, message?: string): ValidationRule => ({
    test: () => {
