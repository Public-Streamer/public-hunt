// // WE ARE NOT USING THIS HOOK ANYWHERE!!! THIS IS DEPRICATED
...
//     try {
//       console.log(
//         "🔍 useLiveKit: Looking up existing room for event:",
//         eventId
//       );
...
//     useCallback(async (): Promise<LiveKitConfig | null> => {
//       try {
//         console.log(
//           "🎫 useLiveKit: Requesting token for event:",
//           eventId,
//           "role:",
//           userRole
//         );
...
//     try {
//       console.log(
//         "🔗 useLiveKit: Starting connection process for event:",
//         eventId,
//         "role:",
//         userRole
//       );
...
//       console.log("🏠 useLiveKit: Room lookup before connection:", {
//         eventId,
//         existingRoom,
//         userRole,
//       });
...
//       if (!existingRoom && userRole === "host") {
//         console.log(
//           "👑 useLiveKit: Host creating new room for event:",
//           eventId
//         );
...
//         console.log(
//           "✅ useLiveKit: Connected to LiveKit room:",
//           config.roomName
//         );
//         setIsConnected(true);
//         setParticipants([
...
//           console.log(
//             "👤 useLiveKit: Participant connected:",
...
//         (participant: RemoteParticipant) => {
//           console.log(
//             "👤 useLiveKit: Participant disconnected:",
//             participant.identity
//           );
...
//       console.log(
//         "🎉 useLiveKit: Successfully connected to room:",
//         config.roomName
//       );
//     } catch (err) {
